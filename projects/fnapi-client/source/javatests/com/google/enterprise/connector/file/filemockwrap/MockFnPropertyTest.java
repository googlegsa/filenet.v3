...
public class MockFnPropertyTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		session.verify();
		IDocument doc = objectStore.getObject("doc2");
		IProperties properties = doc.getProperties();
		property = properties.get(1);
	}

	/*
	 * Test method for 'com.google.enterprise.connector.file.filemockwrap.MockFnProperty.getName()'
	 */
	...
	/*
	 * Test method for 'com.google.enterprise.connector.file.filemockwrap.MockFnProperty.getValueType()'
	 */
