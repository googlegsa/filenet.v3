...
public class FnUserTest extends TestCase {
	...
	/*
	 * Test method for 'com.google.enterprise.connector.file.filejavawrap.FnUser.getName()'
	 */
	public void testGetName() throws FileNotFoundException {
		Session sess = ObjectFactory.getSession(FnConnection.appId,FnConnection.credTag, FnConnection.userLambda1,
				FnConnection.userLambdaPassword1);
		sess.setConfiguration(new FileInputStream(FnConnection.pathToWcmApiConfig));
