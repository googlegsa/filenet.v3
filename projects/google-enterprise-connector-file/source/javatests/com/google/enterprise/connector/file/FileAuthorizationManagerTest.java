	...
	public void testAuthorizeDocids() throws RepositoryException {
				...
				.getAuthorizationManager();
		{
			...
			expectedResults.put("%7B8AE0301C-2F52-46FD-B487-FC7A468A902A%7D",
					Boolean.TRUE);
//			expectedResults.put("{8AE0301C-2F52-46FD-B487-FC7A468A902A%7D",
//					Boolean.TRUE);
	...
	private void testAuthorization(
		...
		for (Iterator i = resultSet.iterator(); i.hasNext();) {
			...
			try {
				expected = (Boolean) expectedResults.get(URLEncoder.encode(uuid,"UTF-8"));
				System.out.println("ok " + URLEncoder.encode(uuid,"UTF-8")) ;
