...
public class FnDocument implements IDocument {
	...
	/**
	 * Fetches the (Meta data)Properties of a document from FileNet.
	 */
	...
	/**
	 * To fetch VersionSeries of the document form FileNet and return.
	 */
	...
	/**
	 * To fetch DateLastModified of the document form FileNet and return.
	 */
	...
	/**
	 * To fetch ClassName of the document form FileNet and return.
	 */
	...
	/**
	 * To fetch permission list applied over the document form FileNet and
	 * return.
	 */
	...
	/**
	 * To fetch contents of the document form FileNet and return.
	 */
