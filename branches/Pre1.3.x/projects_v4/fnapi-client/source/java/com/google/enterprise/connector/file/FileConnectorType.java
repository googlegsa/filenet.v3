	...
	public ConfigureResponse validateConfig(Map configData, Locale language,
		...
		if (validation.equals("")) {
			try {
				...
				logger.log(Level.INFO, "test getObject_factory "
						+ conn.getObject_factory());
				logger.log(Level.INFO, "test getWorkplace_display_url "
						+ conn.getWorkplace_display_url());
				logger.log(Level.INFO, "test getContent_engine_uri "
						+ conn.getContent_engine_uri());
